...
def configure_selenium():
    ...
    service = Service("C:\\webdrivers\\chromedriver.exe")  # Replace with the path to chromedriver
...
# Scrape Amazon Data
def scrape_amazon(keyword, num_pages=1):
...
def main():
    ...
    data = scrape_amazon(keyword, num_pages=num_pages)
